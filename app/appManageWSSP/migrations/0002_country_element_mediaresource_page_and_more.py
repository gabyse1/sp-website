# Generated by Django 4.1.3 on 2022-12-02 21:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author_publicationArticles', to='appManageWSSP.author')),
                ('media', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mediaResource_publicationArticles', to='appManageWSSP.mediaresource')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_publicationArticles', to=settings.AUTH_USER_MODEL)),
                ('publication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='publication_publicationArticles', to='appManageWSSP.publication')),
            ],
            options={
